...
for (i = 9; i < 17; i++) {
    ...
    //* generate a <div> element representing a time-block row for each hour of the day set by values defined in for loop (9 to 17 ==> 9am- 4pm)
    //* set div 'data-hour' and 'class' attributes to representative variable
    //* append each (.)nested time-block div ("row") ()parent container div
    ...
    //* create a <div> element [nested grandchild of containerDiv and child of time-block after appending to each time-block div it is associated with] 
    //* set nested div 'class' attribute (e.g. grid format to left) to representative variable
    //* set text of each nested div to local hour using dayjs format to display the hour (populated by for loop) of each time-block div
    ...
    //* create a <textarea> element [nested grandchild of container div and child of time-block after appending to each time-block div it is associated with] 
    ...
    //* create <button> element [nested grandchild of container div and child of time-block div after appending to each time-block div it is associated with]
